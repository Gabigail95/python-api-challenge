...
VacationPy will first showcase the humidity for each city that was analyzed in  WeatherPy. The data is then filtered to locate cities that would meet the below weather specifications for an ideal vacation: 
...
Once these specifications were implemented, the nearest hotel was located for each of the cities. The final result displayed these cities only, in the OSM map. 
